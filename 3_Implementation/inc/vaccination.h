 ...
 * @return error_t 
 */
error_t display_patientid(patient *);
 ...
 * @return error_t 
 */
error_t find_by_patientid(patient *, int, patient *, int *);
 ...
 * @return error_t 
 */
error_t update_patientrecord(patient *, int, int, int); // last int is 0 -> prod , 1 -> testing
 ...
 * @return patient *
 */
patient *delete_patientid(patient *, int);
 ...
 * 
 */
void delete_allpatientrecords(patient *);
 ...
 * @return error_t 
 */
error_t validate_patientid(FILE **fptr, int);
 ...
 * @return error_t 
 */
error_t patient_openFile(char *addr, char *mode, FILE **fptr);
 ...
 * @return error_t 
 */
error_t patient_saveFile(patient *, FILE **, int *);
